...
interface SwitchProps extends React.ComponentProps<typeof SwitchPrimitive.Root> {
  ...
  //
  // The "on" track colour comes from --switch-on: slate in the builder chrome, and each
  // colour theme's own --foreground inside a rendered centre, so a subscriber's toggles stay
  // on-brand rather than picking up the builder's palette.
  controlColor?: string
}
